...
let EKA_POHJA = ["Lääkeliuoksen pitoisuus on ", "pitoisuus"," mg/ml. ", "nimi", " saa vuorokaudessa ", "määrä", " g painokiloa kohti ja ", " painaa ", "paino", " kg. Kuinka paljon liuosta annat kerrallaan, kun vuorokausiannos jaetaan kolmeen annostelukertaan? Ilmoita määrä millilitroina.", 0];

let TOKA_POHJA = ["Lääkeliuoksen pitoisuus on ", "pitoisuus", " mg/ml. ", "nimi", " tarvitsee vaikuttavaa ainetta ", "määrä", " g/kg kerralla. Kuinka paljon mittaat liuosta, jos potilaan paino on ", "paino", " kg? Ilmoita määrä millilitroina.", 1];

let KOLMAS_POHJA = ["Potilaalle annettavan lääkeliuoksen pitoisuus on ", "pitoisuus", " mg/ml. ", "nimi", " tarvitsee vaikuttavaa ainetta ", "määrä", " mg/kg/vrk. Kuinka monta millilitraa mittaat potilaalle liuosta, jos hän painaa ", "paino", " kg ja lääkettä annetaan kaksi kertaa vuorokaudessa? Ilmoita määrä millilitroina.", 2];

let POHJAT = [EKA_POHJA, TOKA_POHJA, KOLMAS_POHJA];

let NIMET = ["Julma", "Elli", "Mikke", "Jusseh", "MTLVMPR", "Yoker", "Jebbe", "Otti", "Vladimir", "Cirilla", "Leo", "Tuukka", "Justus", "Lucia", "Anda", "Kuura"]
